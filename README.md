...
- ✅ [PRO Version Available](https://appseed.us/product/black-dashboard-pro/django/) - `enhanced UI` and more `features` 
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/72cf565b-b4ee-453a-981c-617a2152fa2e.git
$ cd 72cf565b-b4ee-453a-981c-617a2152fa2e
```
